...
![个人计划](/md/blog.008.jpeg "个人计划")
图4.1 个人计划实体属性图

（2）下图是请假实体和其具备的属性。

![请假](/md/blog.009.jpeg "请假")
图4.2 请假实体属性图

（3）下图是员工实体和其具备的属性。

![员工](/md/blog.010.jpeg "员工")
图4.3 员工实体属性图

（4）下图是企业计划实体和其具备的属性。

![企业计划](/md/blog.011.jpeg "企业计划")
图4.4 企业计划实体属性图

（5）下图是通讯录实体和其具备的属性。

![通讯录](/md/blog.012.jpeg "通讯录")
图4.5 通讯录实体属性图

（6）下图是部门计划实体和其具备的属性。

![部门计划](/md/blog.013.jpeg "部门计划")
图4.6 部门计划实体属性图

（7）下图是公告实体和其具备的属性。

![公告](/md/blog.014.jpeg "公告")
图4.7 公告实体属性图

（8）下图是上下班打卡实体和其具备的属性。

![上下班打卡](/md/blog.015.jpeg "上下班打卡")
图4.8 上下班打卡实体属性图

（9）下图是外出登记实体和其具备的属性。

![外出登记](/md/blog.016.jpeg "外出登记")
图4.9 外出登记实体属性图

（10）下图是会议实体和其具备的属性。

![会议](/md/blog.017.jpeg "会议")
图4.10 会议实体属性图
